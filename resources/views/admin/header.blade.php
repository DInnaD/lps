 ...
 "imageSize": 32
      ...
      <div class="navbar-header">
        ...
        <div id="main-nav" class="collapse navbar-collapse navStyle">
            ...
            <li><a href="{{ url('/admin/portfolios') }}" class="scroll-link">LANDINGPAGES</a></li>
           
            
            <li><a href="{{ url('/admin/peoples') }}" class="scroll-link">PEOPLES</a></li>
            
            <li><a href="{{ url('/admin/services') }}" class="scroll-link"></a></li>
            <li><a href="{{ url('/admin/socials') }}" class="scroll-link"></a></li>
            <li><a href="{{ url('/admin/logos') }}" class="scroll-link"></a></li>
